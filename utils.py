...
class Logger:
    ...
    def plot(self, data):
        ...
        ax[1].plot(data["test"]["acc"]["idx"], data["test"]["acc"]["acc"], label="Test")
        ax[1].plot(data["val"]["expl_acc"]["idx"], data["val"]["expl_acc"]["expl_acc"], label="Expl Val")
        ax[1].plot(data["test"]["expl_acc"]["idx"], data["test"]["expl_acc"]["expl_acc"], label="Expl Test")
        ax[1].legend()
        plt.tight_layout()
